...
title=tk.Label(window,text="BMI CALCULATOR",font=("arial",20),fg="red")
title.pack(pady=20)
...
weight_label=tk.Label(window,text="enter your weight(kgs):")
...
result_label=tk.Label(window,text="",font=("arial",14),fg="red")
